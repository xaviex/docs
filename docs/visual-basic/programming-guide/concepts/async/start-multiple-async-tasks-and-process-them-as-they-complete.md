...
## Downloading the Example  
 You can download the complete Windows Presentation Foundation (WPF) project from [Async Sample: Fine Tuning Your Application](http://code.msdn.microsoft.com/Async-Fine-Tuning-Your-a676abea) and then follow these steps.  
...
> [!CAUTION]
>  You can use `WhenAny` in a loop, as described in the example, to solve problems that involve a small number of tasks. However, other approaches are more efficient if you have a large number of tasks to process. For more information and examples, see [Processing Tasks as they complete](http://blogs.msdn.com/b/pfxteam/archive/2012/08/02/processing-tasks-as-they-complete.aspx).  
...
## Complete Example  
 ...
 You can download the project from [Async Sample: Fine Tuning Your Application](http://code.msdn.microsoft.com/Async-Fine-Tuning-Your-a676abea).  
...
## See Also  
 ...
 [Async Sample: Fine Tuning Your Application](http://code.msdn.microsoft.com/Async-Fine-Tuning-Your-a676abea)

...
You can write asynchronous programs more easily and intuitively by using async/await features. You can write asynchronous code that looks like synchronous code and let the compiler handle the difficult callback functions and continuations that asynchronous code usually entails.  
 ...
 If you don't want to build the applications yourself, you can download "Async Sample: Accessing the Web Walkthrough (C# and Visual Basic)" from [Developer Code Samples](http://code.msdn.microsoft.com/Async-Sample-Accessing-the-9c10497f).  
...
## Prerequisites  
 Visual Studio 2012 or later must be installed on your computer. For more information, see the [Microsoft website](http://go.microsoft.com/fwlink/?linkid=240162).  
...
## See Also  
 [Async Sample: Accessing the Web Walkthrough (C# and Visual Basic)](http://code.msdn.microsoft.com/Async-Sample-Accessing-the-9c10497f)   
 ...
 [Task-based Asynchronous Programming (TAP)](http://www.microsoft.com/downloads/details.aspx?FamilyID=4969771d-9855-4421-baa0-c91848db4ab0)   
